    ...
    <main className="w-full lg:w-2/4">
      <form method="POST" className="w-full">
        ...
        <div className="flex flex-col m-5">
          <label
            className="font-semibold text-l lg:text-xl text-white"
            htmlFor="fullname"
          >
            Nombre Completo
          </label>
          <input
            className=" text-black border-none rounded-lg text:xs lg:text-l p-2"
        ...
        <div className="flex flex-col m-5">
          ...
          <input
            className=" text-black border-none rounded-lg text-l p-2"
            type="text"
        ...
        <div className="flex flex-col m-5">
          ...
          <textarea
            className=" text-black border-none rounded-lg text-l h-28 min-h-[32px] max-h-48 p-2"
            onChange={(e) => setMessage(e.target.value)}
            value={message}
            id="message"
            name="message"
            placeholder="Escriba la consulta aquí"
            required
          />
        </div>
        ...
        <div className="m-5">
          <button
            ...
            className="bg-blue-500 text-white p-2 rounded-lg font-bold hover:bg-blue-800 duration-200 w-full"
            type="submit"
          >
            Enviar
          </button>
        ...
        <div className="text-center mb03">
          <p>
            Gracias por contactarnos! Un operador estará en contacto contigo,
            vía e-mail.
          </p>
        </div>
